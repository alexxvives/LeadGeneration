...
const DOMAIN_TIPS = [
  ...
  },
  {
    ...
    body: "Lodestar enforces per-lead approval and a per-minute rate limit by design — guardrails for your sending reputation.",
  },
  {
      ...
      <section className="mx-auto max-w-7xl px-5 pb-24 pt-10 sm:px-8">
        ...
        <div className="mt-10 rounded-xl border border-amber-400/15 bg-amber-400/5 px-6 py-4">
          <p className="text-sm text-amber-200/80">
            <span className="font-semibold text-amber-300">Bottom line:</span> Lodestar
